...
description: First-time setup flow for image-story-to-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.dragonskills/image-story-to-comic/EXTEND.md` | Current project |
| User | `~/.dragonskills/image-story-to-comic/EXTEND.md` | All projects |
