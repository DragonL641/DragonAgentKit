...
**DEFAULT: Use Doraemon characters** unless user explicitly specifies `--characters` or has character presets in preferences.
...
To use custom characters: `--characters "Student:小明,Mentor:教授"` or define in preferences.
