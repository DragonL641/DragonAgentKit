...
```bash
/image-story-to-comic content.md --storyboard-only
```
...
```bash
/image-story-to-comic content.md --prompts-only
```
...
```bash
/image-story-to-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/image-story-to-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/image-story-to-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/image-story-to-comic comic/topic-slug/ --regenerate 0
```
