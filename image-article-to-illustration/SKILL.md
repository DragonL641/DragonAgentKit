---
name: image-article-to-illustration
...
```
- [ ] Step 1: Pre-check (references, config)
...
| Q4: Language | When article language differs from user preference |
...
| [references/config/first-time-setup.md](references/config/first-time-setup.md) | Setup guide |
