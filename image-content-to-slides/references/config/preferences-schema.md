...
Structure for user preferences in `.dragonskills/image-content-to-slides/EXTEND.md`.
...
Then use with: `/image-content-to-slides content.md --style style-name`
...
1. `.dragonskills/image-content-to-slides/EXTEND.md` (project)
2. `$HOME/.dragonskills/image-content-to-slides/EXTEND.md` (user)

## First-Time Setup

When no preferences file exists, the skill prompts for initial preferences:
...
Creates preferences file at chosen location.
