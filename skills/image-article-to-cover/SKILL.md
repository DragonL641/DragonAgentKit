...
/image-article-to-cover path/to/article.md

# Quick mode: skip confirmation
/image-article-to-cover article.md --quick

# Specify dimensions
/image-article-to-cover article.md --type conceptual --palette warm --rendering flat-vector

# Style presets (shorthand for palette + rendering)
/image-article-to-cover article.md --style blueprint

# With reference images
/image-article-to-cover article.md --ref style-ref.png

# Direct content input
/image-article-to-cover --palette mono --aspect 1:1 --quick
[paste content]
```
...
**Config**: [preferences-schema.md](references/config/preferences-schema.md) | [watermark-guide.md](references/config/watermark-guide.md)
