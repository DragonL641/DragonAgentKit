---
name: image-content-to-infographic
...
```bash
/image-content-to-infographic path/to/content.md
/image-content-to-infographic path/to/content.md --layout hierarchical-layers --style technical-schematic
/image-content-to-infographic path/to/content.md --aspect portrait --lang zh
/image-content-to-infographic  # then paste content
```
