...
6. No content truncation ("Content continues", "Due to length")
...
3. Run `python scripts/verify_claim_support.py verify --dir [folder]`
4. If ANY fails:
...
**Do NOT skip validation.** Every report must pass all three scripts before delivery.
