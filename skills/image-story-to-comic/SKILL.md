...
```bash
/image-story-to-comic posts/turing-story/source.md
/image-story-to-comic article.md --art manga --tone warm
/image-story-to-comic  # then paste content
```
...
- [ ] Step 1: Setup & Analyze
  - [ ] 1.1 Analyze, 1.2 Check existing
...
**Extension Support**: Watermark | Preferred art/tone/layout | Custom style definitions | Character presets | Language preference
...
**Config**:
- [config/preferences-schema.md](references/config/preferences-schema.md) - Preferences schema
...
- Watermark/language configured via preferences
