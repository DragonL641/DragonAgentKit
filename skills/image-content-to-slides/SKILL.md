...
```bash
/image-content-to-slides path/to/content.md
/image-content-to-slides path/to/content.md --style sketch-notes
/image-content-to-slides path/to/content.md --audience executives
/image-content-to-slides path/to/content.md --lang zh
/image-content-to-slides path/to/content.md --slides 10
/image-content-to-slides path/to/content.md --outline-only
/image-content-to-slides  # Then paste content
```
...
2. User's conversation language (input language)
...
```bash
/image-content-to-slides content.md --prompts-only
```
...
```bash
/image-content-to-slides slide-deck/topic-slug/ --images-only
```
...
```bash
# Single slide
/image-content-to-slides slide-deck/topic-slug/ --regenerate 3

# Multiple slides
/image-content-to-slides slide-deck/topic-slug/ --regenerate 2,5,8
```
...
2. Run: `/image-content-to-slides <dir> --regenerate N`
...
| `references/config/preferences-schema.md` | Preferences structure |
...
Custom configurations via preferences. See `references/config/preferences-schema.md` for schema.
