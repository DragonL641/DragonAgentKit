...
/image-content-to-xhs posts/ai-future/article.md

# Specify style
/image-content-to-xhs posts/ai-future/article.md --style notion

# Specify layout
/image-content-to-xhs posts/ai-future/article.md --layout dense

# Combine style and layout
/image-content-to-xhs posts/ai-future/article.md --style notion --layout list

# Direct content input
/image-content-to-xhs
[paste content]

# Direct input with options
/image-content-to-xhs --style bold --layout comparison
[paste content]
```
...
**Config** (Settings):
- `config/preferences-schema.md` - Preferences schema
