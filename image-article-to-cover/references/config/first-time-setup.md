...
description: First-time setup flow for image-article-to-cover preferences
---
...
options:
  - label: "No watermark (Recommended)"
    description: "Clean covers, can enable later in preferences"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.dragonskills/image-article-to-cover/EXTEND.md` | Current project |
| User | `~/.dragonskills/image-article-to-cover/EXTEND.md` | All projects |
...
**Preferences Supports**: Watermark | Preferred type | Preferred palette | Preferred rendering | Preferred text | Preferred mood | Default aspect ratio | Default output directory | Quick mode | Custom palette definitions | Language preference
