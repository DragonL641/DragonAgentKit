...
class EmailSender:
    ...
    def __init__(self, config_path=None):
        ...
        self.app_password = os.environ.get('DAILY_REPORT_SMTP_PASSWORD') or email_config.get('app_password', '')
    ...
    try:
        if use_ssl:
            ...
            with smtplib.SMTP_SSL(smtp_server, smtp_port, context=context) as server:
                server.login(email_config['sender_email'], os.environ.get('DAILY_REPORT_SMTP_PASSWORD') or email_config.get('app_password', ''))
        else:
