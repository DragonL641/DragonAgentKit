...
\```
~/Documents/obsidian/09image/MMDD-{{PATH_PATTERN}}/
├── 01-{{FILE_PATTERN}}.png
├── 02-{{FILE_PATTERN}}.png
└── ...
\```
...
npx -y bun ${SKILL_DIR}/../image-generate/scripts/main.ts \
  --prompt "提示词" \
  --image "~/Documents/obsidian/09image/MMDD-主题名/NN-描述.png" \
  --provider google \
  --ar "{{ASPECT_RATIO}}" \
  --quality "{{RESOLUTION}}"
```
